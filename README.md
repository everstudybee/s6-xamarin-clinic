<div align="center">
    <h1>Xamarin Clinic</h1>
    <h3>
        <a href="#">
            Live demo
        </a>
        <span> | </span>
        <a href="https://github.com/everstudybee/s6-xamarin-clinic">
            GitHub
        </a>
    </h3>
    <p>Mobile app for Clinic</p>
    ...
    <p>
        ...
        <img src="docs/img/xamarin.svg" width="40" height="40" alt="xamarin"/>
...
Mobile application for operating the Clinic. It enables the registration of doctors, patients and visits. MS SQL Server database, Database First approach. 
